...
set output "100_p_A_vs_pfalse.eps"
...
plot "p_A-pro_vs_pf" u 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title "PD", \
     "p_A-maj_vs_pf" u 1:($2*100) w lp lt 2 lw 2 pt 2 ps 2 title "MD", \
     "p_A-cls_vs_pf" u 1:($2*100) w lp lt 3 lw 2 pt 3 ps 2 title "CD"
set output
