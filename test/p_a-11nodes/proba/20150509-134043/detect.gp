...
set output "100_p_A_vs_pdetect.eps"
#set terminal qt font "Times New Roman, 20"
#set xlabel "{/SimSun=20 空洞数量}"
set xlabel "Presence Probability of the Target"
set xrange [0.01:0.1]
set xtics 0.01
set mxtics 1
...
plot "p_A-pro_vs_pd" u 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title "PD", \
     "p_A-maj_vs_pd" u 1:($2*100) w lp lt 2 lw 2 pt 2 ps 2 title "MD", \
     "p_A-cls_vs_pd" u 1:($2*100) w lp lt 3 lw 2 pt 3 ps 2 title "CD"
set output
