...
plot "f_num-pro_vs_pf" u 1:($2*1000) w lp lt 1 lw 2 pt 5 ps 2 title "PD", \
     "f_num-maj_vs_pf" u 1:($2*1000) w lp lt 2 lw 2 pt 2 ps 2 title "MD", \
     "f_num-cls_vs_pf" u 1:($2*1000) w lp lt 3 lw 2 pt 3 ps 2 title "CD"
set output
