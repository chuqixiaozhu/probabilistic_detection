...
set output "100_var_vs_pfalse.eps"
#set terminal qt font "Times New Roman, 20"
#set xlabel "{/SimSun=20 空洞数量}"
set xlabel "Value of Noise Variance"
set xrange [0.1:1.0]
set xtics 0.2
set mxtics 1
...
plot "var-pro_vs_pf" u 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title "PD", \
     "var-maj_vs_pf" u 1:($2*100) w lp lt 2 lw 2 pt 2 ps 2 title "MD", \
     "var-cls_vs_pf" u 1:($2*100) w lp lt 3 lw 2 pt 3 ps 2 title "CD"
set output
