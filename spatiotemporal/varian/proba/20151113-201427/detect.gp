...
plot "var-pro_vs_pd" u 1:($2*100) w lp lt 1 lw 2 pt 5 ps 2 title "PD", \
     "var-maj_vs_pd" u 1:($2*100) w lp lt 2 lw 2 pt 2 ps 2 title "MD", \
     "var-cls_vs_pd" u 1:($2*100) w lp lt 3 lw 2 pt 3 ps 2 title "CD"
set output
