...
plot "range-pro_vs_pf" u ($2*100.0):xtic(1) title "PD", \
     "range-maj_vs_pf" u ($2*100.0):xtic(1) title "MD", \
     "range-cls_vs_pf" u ($2*100.0):xtic(1) title "CD"#, \
